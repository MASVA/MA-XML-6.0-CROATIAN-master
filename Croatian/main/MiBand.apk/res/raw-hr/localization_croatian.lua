...
localization_Croatian_table = {
    ...
    last_week_walked_info_format='Prohodano %d km, potrošeno %d kcal.',
    last_month_walked_format='Prošli mjesec, prohodali ste %d koraka.',
    last_month_walked_info_format='Prohodano %d km, potrošeno %d kcal.',
    ...
    activie_run_consumed="Potrošeno %d kcal. %s",

    get_distance_format=", ukupno od %d m.",
    activity_walk_format="%s Prohodano %d koraka %s",
    activity_walk_consumed_format="Potrošeno %d kcal %s",
